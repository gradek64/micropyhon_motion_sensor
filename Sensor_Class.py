...
class Sensor:
    ...
    def __init__(self, pinNumber, intervalsArray):
        ...
        # x intervals check to make 30s all together for example 3 x arrayOfSeconds
        #for x in range(activeSeriesNum):
            #make alteration for intervals to read from array
